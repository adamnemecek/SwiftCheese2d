...
class PinPathTest: XCTestCase {
    ...
    private let converter = PointConverter.defaultConverter
    ...
    func testSingle_0_0() {
        ...
        let z = converter.convert(point: CGPoint(x: -10, y: 10))
        ...
        XCTAssertEqual(path.v0.point, converter.convert(point: CGPoint(x: -5, y: 10)))
        XCTAssertEqual(path.v1.point, converter.convert(point: CGPoint(x: 5, y: 10)))
        XCTAssertEqual(path.getLength(count: iMaster.count), 1)
        
        
        let points = path.extract(points: converter.convert(points: master), converter: converter)
    ...
    func testSingle_0_1() {
        ...
        XCTAssertEqual(path.v0.point, converter.convert(point: CGPoint(x: -10, y: -5)))
        XCTAssertEqual(path.v1.point, converter.convert(point: CGPoint(x: -10, y: 5)))
        XCTAssertEqual(path.getLength(count: iMaster.count), 1)
    ...
    func testSingle_0_2() {
        ...
        XCTAssertEqual(path.v0.point, converter.convert(point: pt1))
        XCTAssertEqual(path.v1.point, converter.convert(point: pt0))
        XCTAssertEqual(path.getLength(count: iMaster.count), 1)
