...
class Colors {
    ...
    static let master = NSColor(red: 1.0, green: 0.5, blue: 0.0, alpha: 0.7).cgColor
    static let slave = NSColor(red: 0.3, green: 0.6, blue: 0.3, alpha: 0.7).cgColor
    static let border = NSColor(red: 0.6, green: 0.3, blue: 0.3, alpha: 1.0).cgColor
}
